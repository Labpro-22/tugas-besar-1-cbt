...
template <typename T>
struct HasDrawChanceCard<
    T, std::void_t<decltype(std::declval<T &>().drawChanceCard())>>
    : std::true_type {};
...
template <typename T>
struct HasGetChanceDeck<
    T, std::void_t<decltype(std::declval<T &>().getChanceDeck())>>
    : std::true_type {};
...
struct HasExecuteChanceCard<
    GameType, CardType,
    std::void_t<decltype(std::declval<GameType &>().executeChanceCard(
...
template <typename GameType, typename CardType>
struct HasResolveChanceCard<
    GameType, CardType,
    std::void_t<decltype(std::declval<GameType &>().resolveChanceCard(
        std::declval<Player &>(), std::declval<CardType &>()))>>
    : std::true_type {};
...
template <typename GameType, typename CardType>
struct HasDiscardChanceCard<
    GameType, CardType,
    std::void_t<decltype(std::declval<GameType &>().discardChanceCard(
...
template <typename CardType>
void executeChanceCardEffect(Player &player, GameManager &game,
                             CardType &card) {
