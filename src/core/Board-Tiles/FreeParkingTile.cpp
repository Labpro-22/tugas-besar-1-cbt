...
struct HasCollectFreeParking<
    GameType, PlayerType,
    std::void_t<decltype(std::declval<GameType &>().collectFreeParking(
        std::declval<PlayerType &>()))>> : std::true_type {};

template <typename GameType, typename PlayerType, typename = void>
struct HasExecuteFreeParking : std::false_type {};

template <typename GameType, typename PlayerType>
struct HasExecuteFreeParking<
    GameType, PlayerType,
    std::void_t<decltype(std::declval<GameType &>().executeFreeParking(
        std::declval<PlayerType &>()))>> : std::true_type {};
...
template <typename GameType, typename PlayerType>
struct HasResolveFreeParking<
    GameType, PlayerType,
    std::void_t<decltype(std::declval<GameType &>().resolveFreeParking(
        std::declval<PlayerType &>()))>> : std::true_type {};
...
template <typename GameType, typename PlayerType>
struct HasAddFreeParkingPool<
    GameType, PlayerType,
    std::void_t<decltype(std::declval<GameType &>().addFreeParkingPool(
        std::declval<PlayerType &>()))>> : std::true_type {};
